...
from .const import DOMAIN, CONF_INSTALLATION_ID, CONF_GROUPS, CONF_POLLING_INTERVAL, DEFAULT_POLLING_INTERVAL
    ...
    async def async_step_user(self, user_input=None):
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_POLLING_INTERVAL, default=DEFAULT_POLLING_INTERVAL): vol.All(vol.Coerce(int), vol.Range(min=10)),
            }),
            errors=errors,
        )